...
<div class="row center animate__animated animate__fadeIn ">
    <div class="col-md-6">
        <div class="card shadow border-0" style="background: #ccc; opacity: 0.8;">
            <div class="card-header fw-bold border-0 text-center bg-base1">{{ __('Register') }}</div>
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="row mb-2">
                        <div class="col-md-12 offset-md-4">
                            <a href="{{ route('login') }}">เข้าสู่ระบบตอนนี้?</a>
                        </div>
                    </div>
