                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{ route('users.update', Auth::user()->id ) }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" disabled value="{{ $user->email }}" autocomplete="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="file" name="picture" class="form-control @error('picture') is-invalid @enderror" id="">
